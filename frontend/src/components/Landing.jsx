            ...
            {loader ?
                ...
                <div className="min-h-screen w-full bg-slate-700">
                    ...
                    <nav className="flex justify-between items-center px-6 py-4 ">
                        <h1 className="text-white !text-xl md:!text-3xl font-bold tracking-wide">📝 BlogSpace</h1>
                        <div className="flex gap-2 sm:gap-3 items-center">
                            <button
                                ...
                                className="text-white border px-3 py-1  md:!py-2  rounded-full text-sm hover:bg-green-500 hover:text-gray-700 transition font-medium"
                            >
                                Login
                            </button>
                            ...
                            <button
                                ...
                                className=" text-orange-500 border bg-white px-3 py-1  md:!py-2 rounded-full text-sm hover:bg-gray-300 transition font-medium"
                            >
                                Register
                            </button>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center px-4 py-20 gap-6">
                        ...
                        {/* Badge */}
                        <div className="bg-white/20 text-white text-xs sm:text-base md:text-lg px-4 py-1.5 !rounded-full backdrop-blur-sm">
                    ...
                    <div className="text-center py-4 border-t border-white/20">
                        <p className="text-purple-300  text-sm mb-0">
